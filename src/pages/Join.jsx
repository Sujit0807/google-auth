    ...
    <div>
      ...
      <div className="flex justify-between">
        <div className="flex justify-center items-center w-full min-h-screen">
          <div className="py-5 px-5 w-4/5 md:w-3/5 lg:w-2/5 border border-slate-400 md:border-slate-300 shadow-md rounded-md">
          <p className="text-center text-xl text-slate-700 font-semibold my-5">
            Join
          </p>
          <div
            onClick={handleGoogleSignIn}
            className="flex justify-center py-2 px-4 rounded-md border border-slate-400 hover:bg-slate-100 hover:border-slate-800"
          >
          ...
          <div className="flex justify-center relative mt-5 text-xs text-slate-600">
            By clicking you agree to our Code of
